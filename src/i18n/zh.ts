...
export const zh: Record<string, string> = {
  ...
  'settings.draftScan.desc': '扫描库内笔记中的未入账 fin-beancount 草稿块，用于流水视图的草稿分类。默认关：关闭时启动只读账本文件、不遍历全库。',
  ...
  'valuation.kind.depreciation': '折旧计价',
  ...
  'modal.valuation.hint.depreciation': '该账户按折旧派生（valuation: depreciation），手动估值会覆盖折旧值（优先级更高）。',
