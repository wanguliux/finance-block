...
export const en: Record<string, string> = {
  ...
  'settings.draftScan.desc': 'Scan notes for unposted fin-beancount draft blocks, feeding the draft tab in the log. OFF by default: when off, startup only reads the ledger file and does not traverse the whole vault.',
  ...
  'valuation.kind.depreciation': 'Depreciation',
  ...
  'modal.valuation.hint.depreciation': 'This account derives value from depreciation (valuation: depreciation). A manual valuation overrides the depreciated value (higher priority).',
